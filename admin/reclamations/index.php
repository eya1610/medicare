...
<div class="main-content">
    ...
    <?php if(!empty($search)): ?>
        <div class="search-info">
            <?php if(count($reclamations) > 0): ?>
                ✅ <strong><?= count($reclamations) ?></strong> réclamation(s) trouvée(s) pour "<strong><?= htmlspecialchars($search) ?></strong>"
            <?php else: ?>
                ❌ Aucune réclamation trouvée pour "<strong><?= htmlspecialchars($search) ?></strong>"
            <?php endif; ?>
        </div>
    <?php endif; ?>
    ...
    <div class="table-container">
        <div class="table-header-info">
            📋 Liste des réclamations (<?= count($reclamations) ?>)
        </div>
        <table>
            <thead>
                <tr>
            ...
            <tbody>
                <?php if(count($reclamations) > 0): ?>
                    ...
                    <tr>
                        ...
                        <td class="actions">
                            <a href="traiter.php?id=<?= $r['id'] ?>" class="action-btn action-traitement" title="Traiter">
                                ✅ Traiter
                            </a>
                            <a href="modifier.php?id=<?= $r['id'] ?>" class="action-btn action-edit" title="Modifier">
                                ✏️ Modifier
                            </a>
                            <a href="supprimer.php?id=<?= $r['id'] ?>" class="action-btn action-delete" title="Supprimer" onclick="return confirm('Supprimer définitivement cette réclamation ?')">
                                🗑️ Supprimer
                            </a>
                        </td>
                    </tr>
